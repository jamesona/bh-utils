#!/bin/bash
#
# Translate string into NATO phonetics
#
if [ ! -z "$1" ] ; then
if [[ $1 == -a ]]; then (nato abcdefghi;nato jklmnopqr; nato stuvwxyz)|sed 's/ - /#/g'|column -t -s'#';  else
...
echo -e "n
String not entered.n
Usage: $0 [word to show in phonetics]"
exit
fi
